...
int CSCAN_DS(int total_Tracks, vector<int> request_queue, int initial_pos, vector<int> &seek_sequence, int direction,int n)
{
	int total_head_movement=0;
...
int main()
{
    ...
    cout<<"Enter the total size of disk\n";
    cin>>total_Tracks;

    cout<<"Enter the no. of Track to enter in Request queue:\n";
    cin>>n;
    ...
    total_head_movement = CSCAN_DS(total_Tracks, request_queue,initial_pos,seek_sequence,direction,n);
    ...
    cout<<"\n throughput = "<<(float)n/total_head_movement;
